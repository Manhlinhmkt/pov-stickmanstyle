...
|-------|-------|
| Episode_ID | PV_0001 |
| Episode_Title | Your Life as the President's Youngest Son |
| World_ID | WORLD_PRESIDENT_YOUNGEST_SON |
| Identity_Mode | TRANSPARENT_VEIL |
| Structure_ID | LIFE_PRIVILEGE |
| Duration_Profile | EXTENDED |
| Target_Duration_Min | 12-15 |
| Word_Budget | 1176-1470 |
| Hook_Type | HOOK_BORN_DIFFERENT |
| Core_Tension | PRIVILEGE_VS_FREEDOM |
| Secondary_Tensions | IDENTITY_VS_LEGACY, PROTECTION_VS_CONTROL, NORMAL_DESIRE_VS_IMPOSSIBLE_REALITY |
| Stickman_Accessory | slightly oversized suit jacket, noticeably tall proportions |
...
- **Visual note:** Subject stickman must be noticeably TALLER than all other stickmen from PHASE_CONFLICT onward
- **Emotional arc:** WONDER → LONGING → TENSION → DREAD → BITTERSWEET → AMBIGUITY → DEEP_CONNECTION
- **Callback structure:** Tower penthouse opening → tower penthouse return (new meaning)
